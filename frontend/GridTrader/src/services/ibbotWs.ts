/**
 * IBBot WebSocket client
 *
 * Connects to the OrderManagement FastAPI backend WS endpoint (ws://…/ws).
 * Features: auto-reconnect with exponential backoff, keepalive pings.
 * Ported from OrderTrader/src/modules/ibbot/ws.ts
 */
...
export function connectIbbotWs(
  wsUrl: string,
  handlers: IbbotWsHandlers,
): IbbotWsClient {
