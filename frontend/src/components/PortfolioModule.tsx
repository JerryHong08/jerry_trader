      ...
      <div className="flex-1 overflow-auto">
        ...
        {(netLiq > 0 || buyingPower > 0) && (
          <div className="p-3 border-b border-zinc-800 bg-zinc-900/50">
            <div className="text-xs text-zinc-400 mb-2">Account Summary</div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
                <div className="text-xs text-zinc-500">Net Liquidation</div>
              ...
              <div>
                <div className="text-xs text-zinc-500">Init Margin</div>
                <div className="text-sm mt-0.5">{formatCurrency(initMargin, m)}</div>
              </div>
              <div>
                <div className="text-xs text-zinc-500">Maint Margin</div>
                <div className="text-sm mt-0.5">{formatCurrency(maintMargin, m)}</div>
              </div>
              {cushion > 0 && (
                <div>
                  <div className="text-xs text-zinc-500">Cushion</div>
        ...
        <div className="p-3 border-b border-zinc-800 bg-zinc-900/30">
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="text-xs text-zinc-500">Total Market Value</div>
