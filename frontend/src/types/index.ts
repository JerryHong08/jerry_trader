export type ModuleType = 'order-management' | 'rank-list' | 'chart' | 'overview-chart' | 'stock-detail' | 'portfolio' | 'news-room' | 'backtest-chart' | 'backtest-config' | 'backtest-results' | 'labeling' | 'analysis';
