...
Usage:
    python -m jerry_trader.BackendForFrontend.bff --replay-date 20260115 --suffix-id test
...
Examples:
    # Live mode
    python -m jerry_trader.BackendForFrontend.bff

    # Replay mode
    python -m jerry_trader.BackendForFrontend.bff --replay-date 20260115 --suffix-id test

    # Custom host/port
    python -m jerry_trader.BackendForFrontend.bff --host 0.0.0.0
        """,
    )
    parser.add_argument(
        "--host",
