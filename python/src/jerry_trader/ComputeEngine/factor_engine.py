...
if __name__ == "__main__":
    ...
    Usage:
        python -m jerry_trader.FactorEngine.factor_engine
        python -m jerry_trader.FactorEngine.factor_engine --replay-date 20240115
        python -m jerry_trader.FactorEngine.factor_engine --manager-type theta
        python -m jerry_trader.FactorEngine.factor_engine --replay-date 20240115 --manager-type replayer
