"""
Docstring for DataSupply.snapshotDataSupply.fundamentals_fetch
...
from jerry_trader.config import float_shares_dir
from jerry_trader.DataUtils.transforms import _parse_number, _parse_percent
