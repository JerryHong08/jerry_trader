...
Usage:
    python -m jerry_trader.backend_for_frontend.bff --replay-date 20260115 --suffix-id test
...
from jerry_trader.packages.market_snapshot.overview_chart_data_manager import (
...
from jerry_trader.shared.utils.session import make_session_id, parse_session_id
...
Examples:
    # Live mode
    python -m jerry_trader.backend_for_frontend.bff

    # Replay mode
    python -m jerry_trader.backend_for_frontend.bff --replay-date 20260115 --suffix-id test

    # Custom host/port
    python -m jerry_trader.backend_for_frontend.bff --host 0.0.0.0
        """,
    )
    parser.add_argument(
        "--host",
