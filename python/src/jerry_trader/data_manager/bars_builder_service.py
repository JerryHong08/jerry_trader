...
from jerry_trader.data_manager.clickhouse_client import ClickHouseClient
from jerry_trader.data_manager.ohlcv_writer import write_bars
...
from jerry_trader.utils.timezone import (
...
class BarsBuilderService:
    ...
    # Timezone helpers — thin wrappers around jerry_trader.utils.timezone
