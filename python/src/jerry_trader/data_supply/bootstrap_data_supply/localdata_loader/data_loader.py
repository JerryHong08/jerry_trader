...
from jerry_trader.config import data_dir, get_splits_data
from jerry_trader.data_supply.bootstrap_data_supply.localdata_loader.date_utils import (
    resolve_date_range,
)
from jerry_trader.data_supply.bootstrap_data_supply.localdata_loader.path_loader import (
    DataPathFetcher,
)
from jerry_trader.data_supply.bootstrap_data_supply.localdata_loader.ticker_utils import (
    get_mapped_tickers,
)
...
class StockDataLoader:
    ...
    def _filter_low_volume(aligned_tickers: pl.LazyFrame) -> pl.LazyFrame:
        ...
        from jerry_trader.config import low_volume_tickers_csv
