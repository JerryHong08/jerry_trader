...
Usage (from repo root):
    python -m jerry_trader.machine_learning.train
"""
...
from jerry_trader.machine_learning.dataset import build_feature_matrix, split_dataset
from jerry_trader.machine_learning.evaluate import evaluate_model, run_inference_demo
from jerry_trader.machine_learning.mock_data import FEATURE_COLS, generate_mock_dataset
from jerry_trader.machine_learning.model import create_model, predict, save_model
