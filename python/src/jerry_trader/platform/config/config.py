...
# ===================== LLM prompt loader =====================================
_LLM_CONTEXT_DIR = PROJECT_ROOT / "skills" / "analysis"


def load_prompt(filename: str) -> str:
    """
    Read a prompt text file from the skills/ directory.

    Args:
        filename: Name of the prompt file (e.g. "catalyst_news_judge.md").
...
fundamentals_profiles_dir = os.path.join(
    data_dir, "raw/us_stocks_sip/fundamentals_profiles"
)
