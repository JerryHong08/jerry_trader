...
from jerry_trader.platform.config.config import data_dir, get_splits_data
from jerry_trader.services.market_data.bootstrap.date_utils import resolve_date_range
from jerry_trader.services.market_data.bootstrap.path_loader import DataPathFetcher
from jerry_trader.services.market_data.bootstrap.ticker_utils import get_mapped_tickers
...
class StockDataLoader:
    ...
    def _filter_low_volume(aligned_tickers: pl.LazyFrame) -> pl.LazyFrame:
        ...
        from jerry_trader.platform.config.config import low_volume_tickers_csv
