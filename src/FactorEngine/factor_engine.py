...
class FactorManager:
    ...
    def __init__(self, manager_type=None, replay_date=None, replay_id=None):
        """
        ...
        Args:
            ...
            replay_id: Optional replay session ID. (eg. v1, v2, etc.)
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--replay-id",
        help="Optional override for replay_id tag (defaults to replay date)",
        type=str,
    )
